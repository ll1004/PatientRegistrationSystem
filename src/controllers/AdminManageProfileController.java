...
public class AdminManageProfileController implements Initializable {
	...
	static final String TITLE = "Admin Profile Management";
	static final String FXM_URL = "/views/AdminManageProfileView.fxml";
	...
	public static AdminManageProfileController controller = null;
	...
	public void renderAdminInfo() {
		if (AdminModel.user == null) {
			return;
		}
		labelError.setText(null);
		username.setText(AdminModel.user.getUsername());
		password.setText(AdminModel.user.getPassword());
		age.setText(AdminModel.user.getAge() + "");
		phone.setText(AdminModel.user.getPhone());
		String sex = AdminModel.user.getSex();
		if (sex.equals("Male")) {
			radioMale.setSelected(true);
		} else {
			radioFemale.setSelected(true);
		}
		email.setText(AdminModel.user.getEmail());
		city.setText(AdminModel.user.getCity());
		state.setText(AdminModel.user.getState());
		pincode.setText(AdminModel.user.getPincode());
	...
	public void manageSubmit() {
		...
		user.setId(AdminModel.user.getId());

		boolean flag = DaoModel.dao.updateAdmin(user);
		if (flag) {
