...
public class DoctorFinishRegistrationController extends PatientViewRegistrationController {
    // The title of current page
    static final String TITLE = "Doctor Finish Registration";
    static final String FXM_URL = "/views/DoctorFinishRegistrationView.fxml";
    ...
    public static DoctorFinishRegistrationController controller = null;
    ...
    public void finishRegistration() {
        ...
        if (item.getStatus().equals(Registered)) {
            ...
            if (success) {
                getRegistrationInfo();
                this.setPatientStatus("Finished");
            } else {
