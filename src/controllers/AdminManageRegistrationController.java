...
public class AdminManageRegistrationController implements Initializable {
	// The title of current page
	static final String TITLE = "Admin Manage Registration";
	static final String FXM_URL = "/views/AdminManageRegistrationView.fxml";
	...
	public static AdminManageRegistrationController controller = null;
	...
	public void getRegistrationInfo() {
		ArrayList<AdminManageRegistrationController.Registration> ls = DaoModel.dao.getAllPatientRegistrationList();
		...
		for (AdminManageRegistrationController.Registration i : ls) {
			data.add(i);
		}
